...
- **Dashboard surfaces:** `accessibility` (WCAG 2.2 AAA as the target and AA as the floor, with the COGA and Low Vision guidance; applies to every view this package renders).
